...
description: Objects, improvisation prompts, audience tests and decision gates used to generate Solo Titania Chaos 2026.
---
...
[Read the production approach](/production){.contact-button}
