 ...
 * twelve posts under blog/ and was outside this check entirely -- which meant a
 * post could lose its Bulgarian translation, or drift to half the length of the
 * English, and nothing would say so.
 */
